...
class RedpandaKafkaResourceIT {
    ...
    void setup() {
        ...
        //
        //        RedpandaKafkaResource kafkaResource = new RedpandaKafkaResource(subscriptionRepository, kafkaProperties);
        //
    ...
    void producesMessages() throws Exception {
        //        restMockMvc
        //            .perform(post("/api/redpanda-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        //            .perform(get("/api/redpanda-kafka/consume?topic=topic-consume"))
        //            .andExpect(status().isOk())
